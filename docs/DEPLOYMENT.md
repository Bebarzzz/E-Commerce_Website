...
# Database
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/car-dealership?retryWrites=true&w=majority
...
```bash
# Export database
mongodump --uri="mongodb+srv://username:password@cluster.mongodb.net/car-dealership" \
